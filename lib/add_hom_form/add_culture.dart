...
class AddCultureForm extends StatefulWidget {
  @override
  _AddCultureFormState createState() => _AddCultureFormState();
}

class _AddCultureFormState extends State<AddCultureForm> {
  final cultureName = TextEditingController();
      ...
      return MaterialButton(
        ...
        onPressed: () async{
          ...
          if(!_formKey.currentState.validate() || file == null) {
            ...
            child(userId).child(Timestamp.now().toString()).child(cultureName.text).putFile(file);
            ...
            await Firestore.instance.collection("CultureUser").document().setData({
              'cultureName' : cultureName.text,
              'about' : about.text,
          ...
          children: [
            Form(
              ...
              child: Column(
                ...
                children: [
                  FormInputField(
                    inputLabel: "Name of Culture*",
                    hintText: "Culture Name",
                    textController: cultureName,
                    validator: (value){
                      if(value.isEmpty){
