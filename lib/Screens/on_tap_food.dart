...
class OnTapFood extends StatefulWidget {
  
  final FoodData foodData;
  OnTapFood({this.foodData});
  
  
  @override
  _OnTapFoodState createState() => _OnTapFoodState();
}

class _OnTapFoodState extends State<OnTapFood> {
  ...
  void setReview() async{
    ...
    if(reviewController.text != null) {
      await databaseService.saveUserReviewToFireStore(userId: uid,city:widget.foodData.city,typeOfThing: "Food",
          name: widget.foodData.foodName,
  ...
  void getReviews() async {
    await databaseService.getUserReviewsFromFireStore(typeOfThing: "Food",
        city: widget.foodData.city,name:widget.foodData.foodName).then((value) {
      setState(() {
        if(value != null) {
          data = value;
  ...
  Widget build(BuildContext context) {
    ...
    String shortDescription,famousPlace,about;
    if(languageChoice == "Hindi" && (widget.foodData.shortDescriptionHindi!=null ||
        widget.foodData.historyHindi !=null ||  widget.foodData.aboutHindi!=null)) {
      shortDescription = widget.foodData.shortDescriptionHindi;
      famousPlace = widget.foodData.historyHindi;
      about = widget.foodData.aboutHindi;
    }
    else {
      shortDescription = widget.foodData.shoreDescription;
      famousPlace = widget.foodData.famousPlace;
      about = widget.foodData.about;
    }
    ...
    Future speakAbout() async {
      if(clickedAbout == true) {
        await textToSpeech.speak(famousPlace);
        await textToSpeech.setPitch(1);
        await textToSpeech.setSpeechRate(0.8);
        await textToSpeech.setVoice("hi-in-x-hie-network");
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Carousel(
                          ...
                          images: [
                            NetworkImage(widget.foodData.images[0]),
                            NetworkImage(widget.foodData.images[1]),
                            NetworkImage(widget.foodData.images[2])
                          ],
                        ),
                      ),
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: NetworkImage(widget.foodData.images[index]),
                                      )
                                  ),
                                ),
                              ),
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: 'What do you think about ${widget.foodData.foodName}',
                                hintStyle: TextStyle(
                                  fontSize: 18,
                                )
                            ),
