...
class FoodShopForm extends StatefulWidget {
  @override
  _FoodShopFormState createState() => _FoodShopFormState();
}

class _FoodShopFormState extends State<FoodShopForm> {
    ...
    if(clicked ==  false) {
      return MaterialButton(
        ...
        onPressed: () async{
            ...
            StorageUploadTask shop = FirebaseStorage.instance.ref().child("FoodShop").
            child(userId).child(Timestamp.now().toString()).child("ShopPhoto").putFile(passportPhoto);

            final StorageTaskSnapshot shopimage =
            (await uploadThumbnailImage.onComplete);
            final String image = await shopimage.ref.getDownloadURL();


            databaseService.addShopToDatabase(state: stateController.text,
              shopAddress: addressController.text,passportPhoto: imageUrl,shopPhoto:image ,type: "FoodShop",
              ...
              ownerName: ownerController.text,shopName: shopController.text,
                number: contactNumberController.text,city: cityController.text,aadhaarNumber: aadharNumber.text, gstIn: gstIn.text, licenseNumber: licenseNumber.text);
            ...
            Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10,),
                  FormInputField(
                    inputLabel: "Famous Food Items",
                    hintText: "eg : Poha, Samosa,etc",
